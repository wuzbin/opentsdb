 ...
 */
public class HttpPostRpc implements HttpRpc {
...
//        byte[] data = new byte[cb.capacity()];
//        while (cb.readable()) {
//            cb.readBytes(data);
//        }
//        System.out.println(Bytes.pretty(data));
//        query.sendReply("ok");
...
//        }
    ...
    public static void collectStats(final StatsCollector collector) {
        collector.record("rpc.received", requests, "type=http_post");
        collector.record("rpc.errors", hbase_errors, "type=http_post_hbase_errors");
        collector.record("rpc.errors", invalid_values, "type=http_post_invalid_values");
        collector.record("rpc.errors", illegal_arguments, "type=http_post_illegal_arguments");
        collector.record("rpc.errors", unknown_metrics, "type=http_post_unknown_metrics");
    }
}
